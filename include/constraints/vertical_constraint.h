#pragma once
/// @file vertical_constraint.h
/// @brief Forces two points to share the same x-coordinate.
///
/// This is equivalent to constraining the two points to lie on a vertical
/// line. The correction averages their x-coordinates.
...
public:
    ...
    VerticalConstraint(std::shared_ptr<Point> p1,
